...
de mutatie: 1. Este utilizata doar in probleme cu constringeri; 2. Este
efectuata imediat ce este disponibila o populatie de copii; 3. Alege
pentru mutatie in medie jumatate de indivizi; 4. Utilizeaza doua
multiseturi distincte de copii; 5. Este de tip neuniform (fluaj); 6.
Este efectuata o singura data, dupa prima etapa de generare a unei
...
3\. Componentele algoritmilor evolutivi sint: 1. Reprezentarea; 2.
Probabilitatea de mutatie; 3. Functia de evaluare; 4. Probabilitatea de
recombinare; 5. Populatia; 6. Generarea de numere aleatoare; 7.
...
11. Stabilirea diversitatii genetice a populatiei; 12. Mecanismul de
...
[d. Este preferabila atunci cind pentru fiecare gena sint posibile mai
...
pentru mutatie in medie jumatate de indivizi; 4. Utilizeaza doua
multiseturi distincte de copii; 5. Este de tip neuniform (fluaj); 6.
Este efectuata o singura data, dupa prima etapa de generarea a unei
populatii; 7. Este realizata cu probabilitate mica; 8. Este efectuata o
singura data pe parcursul unui algoritm; 9. Determina structura
cromozomiala; 10. Utilizeaza populatia curenta; 11. Este efectuata
iterativ.
...
7\. Fie urmatorii doi cromozomi de tip permutare: { 6, 3, 7, 8, 5, 1, 2,
4, 9} si { 7, 2, 8, 5, 6, 9, 4, 1, 3}. Aplicind operatorul de
recombinare PMX, cu pozitiile 3 si 6 se obtin descendentii: a. 6, 3, 7,
8, 5, 9, 4, 1, 2; b. 7, 4, 6, 8, 5, 1, 2, 9, 3; c. 8, 3, 7, 5, 6, 9, 4,
2, 1; d. 6, 2, 7, 8, 5, 1, 4, 9, 3; e. 7, 2, 8, 5, 6, 1, 3, 4, 9; f. 6,
2, 7, 8, 5, 9, 4, 1, 3; g. 7, 9, 8, 6, 5, 1, 2, 4, 3; h. 7, 3, 8, 5, 6,
9, 2, 4, 1; i. 7, 3, 8, 5, 6, 1, 2, 4, 9; j. 5, 3, 7, 8, 6, 9, 4, 1, 2
...
8\. Tipurile de probleme care pot fi rezolvate pe baza calculului
evolutiv sint: 1. Probleme de optimizare; 2. Probleme de geometrie; 3.
Prelucrarea datelor de dimensiune mare (big-data); 4. Probleme de
modelare; 5. Probleme de validare a datelor; 6. Probleme de simulare; 7.
Alocarea dinamica a datelor in memoria calculatorului; 8. Deplasarea
autonoma a vehiculelor.
...
9\. Fie X=\[ 6 1 8 10 5 7 9 3 4 2 \] o permutare. In urma aplicarii
mutatiei prin amestec pentru pozitiile (2,7) poate fi obtinuta
urmatoarea varianta mutata Y: 1. Y=\[2 6 7 8 10 5 1 9 3 4\]; 2. Y=\[ 6 7
8 10 5 1 9 3 4 2\]; 3. Y=\[ 7 6 8 10 5 1 9 3 4 2\]; 4. Y=\[ 6 7 10 8 5 9
1 3 4 2\]; 5. Y=\[ 6 9 7 5 10 8 1 3 4 2\]; 6. Y=\[ 6 2 8 10 5 1 9 3 4
7\]
...
10\. In cadrul strategiei evolutive cu 2 membri (ES-2M): 1. Este
generata o populatie initiala aleator, din distributia normala; 2. La
fiecare moment al evolutiei algoritmului este mentinut un singur
candidat la solutie; 3. Populatiile sint de dimensiuni mari; 4. Calculul
unui termen nou este realizat prin mutatie gaussiana pentru fiecare
componenta a vectorului curent; 5.Sint rezolvate probleme pe spatii
continue; 6. Fiecare termen este calculat in maniera stochastica; 7.
Calculul unui termen nou este realizat prin mutatie gaussiana pentru o
componenta selectata aleator din vectorul curent; 8. Este intentionata
cresterea calitatii medii a populatiei curente; 9. Este garantata
obtinerea unui optim global; 10. La inceputul fiecarei iteratii este
testata dimensiunea populatiei curente; 11. Sint creati descendenti
obtinuti din populatia curenta prin recombinare locala.
...
[e. Obligatoriu dupa extragerea celui mai bun individ din populatia
finala]{.mark}

12\. Algoritmul ES2M

[a. Este algoritmul auto-adaptiv primar]{.mark}
...
13\. Fie urmatorul cromozom de tip permutare: {7, 6, 12, 14, 3, 10, 8,
15, 11, 5, 4, 1, 13, 2, 9}. In urma aplicarii operatorului de mutatie
prin amestec s-a obtinut cromozomul: {7, 14, 13, 12, 1, 15, 2, 8, 6, 3,
11, 5, 10, 4, 9}. Cele doua pozitii utilizate pentru amestec sint: 1. 1
si 14; 2. 4 si 15; 3. 3 si 15; 4. 4 si 8; 5. 2 si 15; 6. 1 si 12; 7. 2
si 14; 8. 2 si 13; 9. 1 si 15; 10. 1 si 13; 11. 3 si 13
...
14\. In cadrul unui algoritm genetic operatia de selectie a
...
Indivizii alesi sint intotdeauna fezabili; 6. Uneori utilizeaza factori
aleatori; 7. Asigura perpetuarea individului cu calitate maxima din
...
15\. Algoritmul Hillclimbing: 1. Se aplica asupra unui singur punct din
spatial de cautare; 2. Aplicarea se poate repeta pentru mai multe puncte
pentru a creste performantele; 3. Este inspirat din tehnicile de
alpinism; 4. Gaseste întotdeauna solutia optima; 5. Gäseste uneori
solutia optima; 6. Calculele se încheie atunci cînd temperatura
sistemului devine zero; 7.

De obicei gäseste un punct de optim local; 8. Se utilizeazä numai pentru
...
16\. In cadrul unui algoritm de clasa strategiilor evolutive,
reprezentarea cromozomilor: 1. Poate fi oricare dintre: siruri binare,
...
folosit (discreta/intermediara); 5. Se alege in functie de problema care
...
Contine atit descrierea individului candidat cit si parametrii care
...
17\. Fie X=\[ 6 1 8 10 5 7 9 3 4 2 \] si Y=\[ 9 8 7 3 6 1 5 10 4 2\]
permutari. Care urmasi sint generali prin utilizarea operatorului CX?
...
18\. în cadrul unui algoritm evolutiv populatia initiala: 1. Este
generate înaintea începerii evolutiei propriu-zise; 2. Este generata
dupa fiecare ciclu evolutiv (care presupune efectuarea operatiilor de
selectie, recombinare, mutatie, evaluare); 3. Este generata la începutul
fiecarui ciclu evolutiv; 4. Este generata aleator; 5. Este generata
utilizînd distribute de probabilitate uniforma; 6. Este generata
utilizînd distributia de probabilitate normala; 7. Este setata pe
multimea vida.
...
[d. Necesita operatori de variatie special definiti]{.mark}

e\. Nu permite mai mult de doua gene eu aceeasi valoare într-un cromozom

20\. În algoritmii genetici, alegerea unei anumite reprezentări: 1. Este
independentă de problema de rezolvat; 2. Depinde de problema de
rezolvat; 3. Poate fi făcută aleator; 4. Este imposibilă, fiind folosită
doar reprezentarea prin numere reale; 5. Influențează calitatea soluției
furnizate
...
21\. În cadrul unui algoritm evolutiv condiția de terminare: 1. Este
obligatorie; 2. Nu este indicată; 3. Include obligatoriu, direct sau
indirect, controlul numărului de iterații (numărul populațiilor
generate); 4. Nu poate fi implementată; 5. Este utilizată doar în cadrul
GA, nu și în cadrul ES.
...
[e. estimeaza nivelul de adaptare a individuliui]{.mark}

26\. Fie permutarile x=\[10 2391 7648 5\] si y=\[5 4 7 2 1 9 3 6 8 10\],
un cromozom copil rezultat prin PMX este c=\[ 5 2 3 9 1 4 7 6 8 10\].
Atunci ordinea considerarii parintilor si respectiv punctele de
incrucisare sint:
...
27\. Care din urmatoarele metode pot fi folosite in cadrul algoritmilor
memetici pentru a îmbunatati informatia in interiorul unei populatii: 1.
recursivitate; 2. hillclimbing; 3. divide et impera; 4. strategie
evolutivä eu doi membri; 5. backtracking; 6. metode exacte; 7. metode
...
28\. In cadrul unui algoritm evolutiv populate initiala: 1. Este
...
fiecarui ciclu evolutiv; 4. Este generata aleator; 5. Este generata
utilizind distribute de probabilitate uniforma; 6. Este generata
utilizind distribute de probabilitate normalâ; 7. Este setatä pe
multimea vidâ.
...
29\. In cadrul unui algoritm genetic operatia de recombinare: 1. Este
efectuata o singura data pe parcursul unui algoritm genetic; 2. Este
efectuata imediat dupa fiecare etapa de selectie a parintilor; 3. In
general probabilitatea de recombinare nu conteaza in rezolvarea
problemelor prin algoritmi genetici; 4. Este efectuata imediat înaintea
fiecarei proceduri de mutatie; 5. Este efectuata imediat inaintea
fiecarei etape de selectie a parintilor; 6. Utilizeaza populatia de
parinti; 7. Este utilizata doar în probleme fara constringeri; 8. Este
utilizata cu probabilitate mare; 9. Este utilizata cu probabilitate
mica; 10. Este efectuatä o singurä datä, dupä prima etapä de selectie a
parintilor.
...
[a. Evolutia naturala biologica]{.mark}
...
31\. Care din urmatorii operatori pot fi utilizati intr-un algoritm
genetic care foloseste reprezentarea prin siruri de numere reale? 1.
Negarea; 2. Negarea fuzzy; 3. Resetarea pseudo-aleatoare; 4. Resetare
determinista; 5. Mutatia uniforma; 6. Mutatia neuniforma cu distribute
fixata; 7. Mutatia locala; 8. Interschimbarea; 9. Inserarea; 10. Mutafla
rapidä; 11. Amestecul; 12. Mutafia globalä;13. Inversiunea; 14.
Recombinare unipunct;15. Recombinare multipunct; 16.Recombinare
uniformä; 17. Recombinarea rädäcinilor; 18. Recombinare aritmeticä
simplä; 19. Recombinare aritmeticä singularä; 20. Recombinare aritmeticä
totalä; 21. Recombinarea sirurilor maxime; 22. Partially mapped
crossover; 23. Recombinare de ordine; 24. Recombinarea muchiilor; 25.
Recombinarea ciclicä
...
32\. In cadrul unui algoritm din clasa strategiilor evolutive,
reprezentarea cromozomilor: 1. Poate fi oricare dintre: siruri binare,
siruri de numere intregi, siruri de numere reale, permutari; 2. Poate fi
numai de tip sirui de numere intregi sau reale; 3. Poate fi numai de tip
siruri de numere reale; 4. Nu influenteaza tipul de recombinare folosit
(discretà / intermediarâ); 5. Se alege în functie de problema care se
rezolva; 6. Influenteaza tipul de recombinare folosit; 7. Are influenta
asupra mecanismului de selectie a generatiei urmatoare; 8. Confine atit
descrierea individului candidat cît \$i parametrii care controleazä
evolufia sa.
...
33\. In cadrul unui algoritm genetic care maximizeaza o functie
(fitness): 1. Selectia generatiei urmatoare este obligatoriu bazata pe
virsta; 2. Sint rezolvate doar probleme cu constringeri; 3. Mutatia este
realizata cu probabilitate mica; 4. Nu este recomandata utilizarea
selectiei FPS; 5. Multisetul copiilor este tara duplicate; 6. Selec\^ia
supraviejuitorilor este determinatâ de calitate çi/sau factorul vîrstâ;
7. Recombinarea este realizatä rareori; 8. Seurmäreste determinarea unui
punct de maxim global; 9. Structura cromozomialä diferä daeà functia
este translatatâ.
...
34\. Intr-un algoritm genetic, populate initiala: 1. Este generata pina
cind este atins un optim local; 2. Este construita o singura data ; 3.
Sufera mutatie cu o probabilitate relativ mica; 4. Trebuie modificata la
fiecare iteratie; 5. Contine exclusiv indivizi fezabili; 6. Este formata
din indivizii care tree in generatie urmatoare; 7. Este generata
utilizind distributie de probabilitate uniforma.
...
20\. Care din urmatoarele afirmatii nu e adevarata pentru modelul
generational?
...
1.  Fie X=\[6 1 8 10 5 7 12 43 9 3 4 2\] o secventa de numere intregi,
    In urma aplicarii mutatiei fluaj poate fi obtinuta urmatoarea
    varianta mutata:
...
>
> 18.fie x =6 1 8 10 5 7 9 3 4 2  o permutare  in urma aplicarii
> mutatiei prin amestec pt pozitiile 2 7 poate fi obtinuta urmatoare
> variant mutant
>
...
> 7 3 8 5 6 9 2 4 1
>
> 27\. Fie urmatorii doi cromozomi de tip permutare 6 3 7 8 5 1 2 4 9 si
> 7 2 8 5 6 9 4 1 3 . aplicand operatoruld e recombinare pmx cu
...
1.  In algoritmii genetici, **reprezentarea prin permutări**
...
1.  **Tipurile de probleme care pot fi rezolvate pe baza calculului
...
1.  **Intr-un algoritm evolutiv**, functia de tip calitate: 1. Evalueaza
...
1.  **In algoritmii genetici, reprezentarea binara**
...
1.  **Componentele algoritmilor evolutivi sunt: **1. Reprezentarea; 2.
...
1.  **Calculul evolutiv este inspirat din**
...
1.  **Caracteristicile unui algoritm genetic clasic(canonic) sunt**: 1.
...
1.  **In cadrul unui algoritm genetic operatia de recombinare:**
...
1.  **Fie urmatorii doi cromozomi de tip permutare {6, 3, 11,7, 14, 8,
...
1.  **In cadrul unui algoritm din clasa strategiilor evolutive,
    reprezentarea cromozomilor**
...
1.  **Fie urmatorul cromozom de tip permutare {7, 6, 12, 14, 3, 10, 8,
    15, 11, 5, 4, 1, 13, 2, 9} In urma aplicarii operatorului de mutatie
...
1.  **In cadrul unui algoritm genetic operatia de mutatie**
...
1.  Intr-un algoritm evolutiv, functia de tip calitate:
...
1.  In cadrul unui algoritm genetic operatia de selectia a parintilor
...
1.  Componentele algortmilor evolutivi sunt:
...
1.  In cadrul uni algoritm genetic operatia de selectie a
    supravietuitorilor
...
1.  Caracteristicile unui algoritm genetic clasic(canonic) sunt:
...
1.  Care dintre urmatorii operatori pot fi utilizati intr-un algoritm
    genetic care foloseste reprezentarea prin siruri de numere reale:
...
1.  In cadrul unui algoritm genetic operatia de selectie a 
    supravietuitorilor
...
1.  Intr-un algoritm evolutiv, functia fitness:

- Evalueaza calitatea fiecarui candidat

1.  Fie urmatorul cromozom de tip permutare {7, 6, 12, 14, 3, 10, 8, 15,
...
1.  In algorimii genetici, reprezentarea prin permutari

- Are nevoie de operatori speciali definite

1.  Algoritmul Hillclimbing
...
1.  care nu este un mecanism de selectie: -\> ruleta complicata

<!-- -->

1.  Ruleta multi-brat trebuie rotita doar o data pentru a executa
    intregul proces de selectie al parintilor

<!-- -->

1.  Care mecanism de selectie reproduce rezultate cat mai apropiate de
    distributia de probabilitate? -\> SUS(\...)

<!-- -->

1.  Mecanismul de selectie turnir -\> nu respecta distributia de
    probabilitate de selectie

<!-- -->

1.  Care din urmatoarele nu sunt modele de populatie? -\> cu generatii,
    cu dimensiune fixa, cu dimensiune variata, cu stari instabile

<!-- -->

1.  Care sunt modele de populatie? -\> cu stari stabile

<!-- -->

1.  In cadrul algoritmilor genetici, urmatoarea generatie este selectata
    dintre: 

> -\> indivizii generatiei curente si descendentii obtinuti dupa etapa
> de mutatie

1.  Care din urmatoarele este un dezavantaj pt distributia de
    probabilitate FPS? -\> convergenta premature

<!-- -->

1.  De cate ori tre rotit bratul ruletei simple pentru a executa
    intregul proces de selectie al parintilor pt o populatie cu tz
    cromozomi-\> de tz ori

<!-- -->

1.  In cadrul algoritmilor genetici, generatia urmatoare este selectata
    dintre:

>  -\> indivizii generatiei curente si descendentii obtinuti dupa etapa
> de mutatie

1.  Care dintre urmatoarele este falsa pt modelul generational?

> -\> nu tine cont de calitatea cromozomilor

1.  Daca aplicarea unui operator de recombinare produce indivizi
    aberanti, atunci:
...
1.  Mecanismul de selectie turnir -\> este intotdeauna un tip
    determinist
...
1.  Recombinarea multipla

>  -\> produce rezultate mai bune doar in unele cazuri particulare

1.  In cazul reprezentarii cu siruri de numere intregi, recombinarile
    aritmetice:

> -\> se pot aplica numai daca toate perechile de alele de pe pozitii
> identice sunt fie pare, fie impare

1.  Pentru a pastra cat mai bine informatia referitoare la pozitiile
    absolute ale alelelor in cromozomii parinti se foloseste operatorul:

> -\> CX (Cycle crossover)

1.  Pentru problemele in care reprezentarea prin permutari semnifica
...
1.  Intr-un algoritm evolutiv, functia fitness: -\> Evalueaza calitatea
    fiecarui individ

<!-- -->

1.  In cadrul strategiilor evolutive: -\> Mutatia este aplicata cu
    probabilitate
...
1.  Care dintre urmatoarele este un dezavantaj al utilizarii
...
1.  De cate ori trebuie rotit bratul ruletei simple pentru a executa
...
1.  In cazul GA generatia urmatoare este selectata dintre:
...
1.  Ce aritate are operatorul de recombinare in GA (cati operanzi
    utilizeaza) ?
...
1.  Care mecanism de selectie produce rezultate mai apropiate de
...
1.  Mecanismul de selectie turnir:
...
1.  Care dintre urmatoarele NU este mechanism de selectie?
...
1.   In cazul recombinarii cu nr intregi, recombinarile aritmetice:
...
1.   De cite ori trebuie rotit bratul ruletei multi-brat pt a executa
...
1.  Care dintre urmatoarele afirmatii **nu** e adevarata pt modelul
    generational?
...
1.  Pentru problemele de dependenta de adiacente se foloseste operatorul
    de recombinare:
...
1.  Care dintre urmatoarele este un model de populatie?
...
![](media/image1.png){width="0.27847222222222223in"
height="0.24375in"}A. Necesită operatori de variație special definiți

![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}B.\
Nu permite utilizarea de operatori de mutație 

![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}C. Nu este utilizată
...
24\. Intr-un algoritm evolutiv, functia fitness: 1. Evalueaza calitatea
algoritmului; 2. Trebuie selectata aleator; 3. Evalueaza viteza de
gasire a solutiei fata de consumul de resurse; 4. Trebuie modificată la
...
![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}a. 6,7,8

![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}b. 1,3

![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}c. 4,5

![](media/image1.png){width="0.27847222222222223in"
height="0.24375in"}d. 9 

![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}e. 2,3
...
![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}a. C1=\[ 6 7 8 10 5 1 9 3 4 2 \], C2=\[ 9 8 1 3 6 7 5
10 4 2 \]

![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}b. C1=\[ 8 7 10 5 1 9 3 4 2 6 \], C2=\[ 2 9 1 8 3 6 7
5 10 4 \] 

![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}c. C1=Y, C2=X

![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}d. C1=\[ 2 6 7 8 10 5 1 9 3 4 \], C2=\[ 2 8 1 3 6 7 5
10 4 9 \]

![](media/image1.png){width="0.27847222222222223in"
height="0.24375in"}e. C1=\[ 6 8 7 10 5 1 9 3 4 2 \], C2=\[ 9 1 8 3 6 7 5
10 4 2 \]

26\. In cadrul unui algoritm genetic operatia de selectie a
supravietuitorilor: 1. Se aplica asupra populatiei curente; 2. In unele
variante necesita calcularea unei distributii de probabilitate de
selectie; 3. Utilizează întotdeauna factori aleatori; 4. Alege generația
...
![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}a. 2, 3, 4, 5, 6, 11

![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}b. 4, 8, 11

![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}c. 1,7

![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}d. 6, 8, 11

![](media/image1.png){width="0.27847222222222223in"
height="0.24375in"}e. 2, 4, 5, 6, 12 
...
![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}a. Operatorul de mutatie cel mai utilizat este
mutatia prin interschimbare

![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}b. Sunt utilizati operatori de recombinare OCX

![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}c. Nu se permite utilizarea de operatori de mutație

![](media/image1.png){width="0.27847222222222223in"
height="0.24375in"}d. Mutația este aplicată cu probabilitate 1 

![](media/image2.png){width="0.27847222222222223in"
height="0.24375in"}e. Reprezentarea este prin vectori binari
...
**2.** Intr-un algoritm evolutiv, functia fitness: 1. Evalueaza
...
permutari. Care urmasi sint generati prin utilizarea operatorului CX? 
...
**4.** Fie urmatorii doi cromozomi de tip permutare: {6, 3, 11, 7, 14,
8, 5, 15, 1, 2, 4, 13, 9, 10, 12 } și {7, 1, 15, 13, 2, 14, 6, 10, 12,
11, 4, 8, 3, 9, 5}. Aplicind operatorul de recombinare PMX, cu pozitiile
4 și 8 se obtin descendentii: a. 5 3 15 13 2 14 6 10 12 8 4 7 9 11 1; b.
...
**5.** In cadrul unui algoritm genetic operatia de selectie a
supravietuitorilor: 1. Se aplica asupra populatiei curente; 2. In unele
variante necesita calcularea unei distributii de probabilitate de
selectie; 3. Utilizează întotdeauna factori aleatori; 4. Alege generația
următoare dintre indivizii disponibili după operația de mutație; 5.
...
1.  In algoritmii genetici, **rerezentarea prin siruri de numere
    intregi**
...
2.  In algoritmii genetici, reprezentarea prin permutari: ​**necesita
    operatori de variatie special definiti (D)**​.

3.  Calculul evolutiv este inspirat de: ​**evolutia naturala biologica
    (A).**

4.  In algoritmii genetici, reprezentarea binara: ​**(B) A fost primul
    tip de reprezentare a cromozomilor in algoritmii genetici**

5.  Caracteristicile unui algoritm genetic clasic: **(E)1,3,5,8
    \--1.Reprezentarea populatiei este realizata prin intermediul
    sirurilor binare, 3.Probabilitatea de selectie a**

> **unui individ in multisetul parintilor este proportionala cu valoarea
> functiei de evaluare pentru el; 5. Probabilitatea efectuarii unei
> mutatii este mica;**
>
> **8.Probabilitatea efectuarii recombinarii este mare**

6.  Intr-un algoritm evolutiv, functia de tip calitate: ​**Evalueaza
...
> d.13 1 10 [​7 14 8 5 15 ​]{.underline}12 11 4 2 3 9 6 - primul copil

e.  5 3 15 13 2 14 6 10 1 8 4 7 9 11 12

f.  13 1 15 7 14 8 5 10 12 11 4 2 3 9 6

g.  [​13​]{.underline} 12 11 [7​ 14 8 5 15]{.underline} 1 10 4 2 3 9
    6[​]{.underline}

h.  [​13​]{.underline} 1 11 [​7 14 8 5 15]{.underline} 12[​]{.underline} 10
    4 2 3 9 6
...
**5. In cadrul unui algoritm din clasa strategiilor evolutive, operatia
de recombinare:** a. Este de tip local sau global
...
**7,** [​**6, 12, 14, 3, 10, 8, 15, 11, 5, 4, 1, 13, 2,**​]{.underline}
**9 7, 14, 13, 12, 1, 15, 2, 8, 6, 3, 11, 5, 10, 4, 9** a. 3 si 13
...
i.  Se efectueaza o singura data, dupa generarea populatiei initiale
    **(**​ **mutatia se face de mai multe ori; in cazul unui algoritm
    genetic, mutatia se face in fiecare era)**
...
b.  In unele variante necesita calcularea unei distributii de
    probabilitate de selectie
...
**[Structura EA]{.underline}**

![](media/image3.jpg){width="6.276099081364829in"
height="3.429961723534558in"}

**[Structura GA]{.underline}**

> ![](media/image4.png){width="6.276666666666666in"
> height="2.986666666666667in"}

![](media/image5.png){width="6.5in" height="6.465277777777778in"}

![](media/image6.png){width="6.5in" height="5.622916666666667in"}

![](media/image7.png){width="6.5in" height="5.448611111111111in"}

![](media/image8.png){width="6.5in" height="5.552777777777778in"}

![](media/image9.png){width="6.5in" height="5.7965277777777775in"}

![](media/image10.png){width="6.5in" height="5.075in"}

![](media/image11.png){width="6.5in" height="5.579166666666667in"}

![](media/image12.png){width="6.5in" height="5.300694444444445in"}

![](media/image13.png){width="6.5in" height="5.83125in"}

![](media/image14.png){width="6.5in" height="5.5875in"}
